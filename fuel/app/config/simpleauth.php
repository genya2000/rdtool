...
return array(
	...
	'groups' => array(
		 ...
		 *
		  ...
		  1    => array('name' => 'Users', 'roles' => array('user' ,'media', 'agency',',anager')),
                  10    => array('name' => 'media', 'roles' => array('media')),
                  20    => array('name' => 'agency', 'roles' => array('agency')),
                  30    => array('name' => 'manager', 'roles' => array('manager')),
	...
	'roles' => array(
		 ...
		 *
                 */
                'user'  => array('admin' => array('create','read','update', 'delete')),
                'media'  => array('media' => array('read')),
                'agency'  => array('agency' => array('read')),
                'manager'  => array('manager' => array('read')),
	 ...
	 */
	'login_hash_salt' => 'put_some_salt_in_here01',
