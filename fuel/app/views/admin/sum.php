      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="sum">データ集計</a></li>
            <li><a href="useradd">ユーザー登録</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				-->
                                 <h1>リダイレクトURLデータ確認</h1>
	  
	   <p class="lead">ここでは、URLの確認とデータの集計結果を表示します。</p>
                                <hr>
           ...
           <form method="post" action="./sum">
               <?php
                ...
                <p>
	<!--
                クライアントコード<input size="18" type="text" maxlength="16" name="mid" value="<?php $mid; ?>"><br /><br />
                -->
                <div class="form-group">
                        <label for="name">パラメータ</label>
		<input size="20" type="text" maxlength="20" name="pid" value="<?php $pid; ?>" style="ime-mode:disabled;" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="name">計測期間（年月日）</label>
		...
		<input type="submit" value="送信" class="btn">
           ...
           <hr>
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <thead>
                        <tr><td class="col-xs-12 col-sm-1 col-md-1">ID</td><td class="col-xs-12 col-sm-4 col-md-4">案件名</td><td class="col-xs-12 col-sm-5 col-md-5">リダイレクトURL</td><td class="col-xs-12 col-sm-2 col-md-2">アクセス日時</td></tr>
                    </thead>
                    <?php foreach ($sql_result_details as $row) { ?>
                    <tbody>
                    <?php
                    ...
                    ?>
                        <tr><td><?php print $row['counter'];?></td><td><?php
                        
                        
                        $sql_result_camp = DB::select()->from('mst_campaign')->where( 'parameterid' , $row['parameterid'] )->as_assoc()->execute();  
                        foreach ($sql_result_camp as $row_camp) {
                        echo $row_camp['campname']; 
                        }
                        
                        
                        ?></td><td>http://<?php print $hostname.$rd_dir; ?>/rd.php?mid=<?php print $row['medianame'];?>&pid=<?php print $row['parameterid'];?></td><td><?php print $row['created_at'];?></td></tr>
                    </tbody>
                    <?php
