...
<body>
      <?php
            ...
            try{
               ...
               function makeRandStr($length = 14) {
                ...
                /* URL生成の基本条件を設定 */
                if ($mid && $linkurl) 
                    $parameterurl = 'http://'.$_SERVER['SERVER_NAME'].'/rd.php?mid=' .$mid.'&pid=' .$parameterid;
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="rgister">キャンペーン登録</a></li>
	...
	<div class="container">
	   ...
	   <p class="lead">ここでは、リダイレクトURLを発行します。</p>
                                <hr>
                                 <div class="starter-template">
	
           
           <form name="f1" method="post" action="./register.php" onSubmit="return checkForm()">
		
            <div class="form-group">
                <label for="name">メディアコード<br><span style="color:#ff0000;">(半角英数字)<br><span style="color:#ff0000;">※パラメータ内に表示されます</span></label>
		<input size="18" type="text" maxlength="256" name="mid" value="<?php $mid; ?>" style="ime-mode:disabled;" class="form-control" />
                </div>
               
            <div class="form-group">       
		<label for="name">キャンペーン名</label>
                <input size="20" type="text" maxlength="5000" name="campname" value="<?php $campname; ?>" class="form-control">
		</div>
            
               
            <div class="form-group">       
		<label for="name">遷移先URL</label>
                <input size="20" type="url" maxlength="5000" name="linkurl" value="<?php $linkurl; ?>" class="form-control">
		</div>
		...
		<input type="submit" value="送信" class="btn">
            ...
            <div style="width:95%;height:150px;margin:0 auto;padding:20px;border: 4px solid #cccccc;margin-top:30px;">        
		リダイレクトURL<br>
                <strong><?php echo $parameterurl ?></strong>
                </div>
            このURLをコピーしてメディアにアナウンスしてください。
