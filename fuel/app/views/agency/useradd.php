...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="rgister">キャンペーン登録</a></li>
            <li class="active"><a href="useradd">ユーザー登録</a></li>
	...
	<p class="lead">ユーザーID／所属グループ登録</p>
		...
		<!-- <label for="name">所属グループ(半角英数字)</label> -->
              <input size="20" type="hidden" maxlength="5000" name="group" value="1" style="ime-mode:disabled;" class="form-control" required>
            ...
            <div class="form-group">       
		<label for="name">所属グループ(半角英数字)</label>
                <input size="20" type="text" maxlength="5000" name="usergroup" value="<?php $usergroup; ?>" style="ime-mode:disabled;" class="form-control" required>
                </div>
               -->
