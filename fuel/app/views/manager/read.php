...
<body>
     ...
     <header>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../index.php">redirecttool</a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="index">ホーム</a></li>
            <li class="active"><a href="read">キャンペーン確認</a></li>
            <li><a href="useradd">メディア登録</a></li>
            <li><a href="register">キャンペーン登録</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				-->
                                 <h1>リダイレクトURLリスト</h1>
                                <p class="lead">ここでは、リダイレクトURLとデータを表示します。</p>  
                                <hr>
           ...
           <form method="post" action="./read">	
                ...
                <label for="name">メディアコード</label>
                <input size="18" type="text" maxlength="30" name="mid_q" class="form-control" />
                </div>
                <!--
                <div class="form-group">
                <label for="name">パラメータID</label>
                <input size="20" type="text" maxlength="20" name="pid" value="" class="form-control" /><br /><br />
                </div>
                </div>              
                -->
	<br><br><div class="form-group">
	       ...
	       <input type="submit" value="送信" class="btn">
                ...
                <h3>メディア別キャンペーンリスト</h3>
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <thead>
                        <tr><td class="col-xs-12 col-sm-1 col-md-1">ID</td><td class="col-xs-12 col-sm-1 col-md-1">メディアID</td><td class="col-xs-12 col-sm-2 col-md-2">案件名</td><td class="col-xs-12 col-sm-3 col-md-3">遷移先URL</td><td class="col-xs-12 col-sm-4 col-md-4">リダイレクトURL</td><td class="col-xs-12 col-sm-1 col-md-1">登録日時</td><td>成果</td></tr>
                    </thead>
                    
                    <?php foreach ($sql_result_comall as $row_com) { ?>
                    <tbody>
                                <tr><td><?php echo $row_com['id'];?></td><td><?php echo $row_com['medianame'];?></td><td><?php echo $row_com['campname'];?></td><td><?php echo $row_com['linkurl'];?></td><td>http://info-lab.tokyo/lab/redirect/rd.php?mid=<?php echo $row_com['medianame'];?>&pid=<?php echo $row_com['parameterid'];?></td><td><?php echo $row_com['created_at'];?></td><td>
                            <form method="post" action="./campaigndetail">
                                    <input type="hidden" name="pid" value="<?php print $row_com['parameterid'];?>">
                                    <input type="hidden" name="mid" value="<?php print $row_com['medianame'];?>">
                                    <input type="hidden" name="to" value="________">
               ...
               <div class="form-group">
               <div class="col-xs-12">
		<input type="submit" name="subm" value="送信" class="btn">
                </div>
               </div>
                     </form>
                     <br>
                     <br>
                <?php
                $hide= isset($_POST['subm']) ? htmlspecialchars($_POST['subm']) : null;
                if(!empty($hide)){
                $sql_result = DB::select()->from('mst_campaign')->execute();  
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        <tr><td><?php print $row['id'];?></td><td><?php print $row['medianame'];?></td><td><?php print $row['campname'];?></td><td><?php print $row['linkurl'];?></td><td>http://<?php print $hostname.$rd_dir; ?>/rd.php?mid=<?php print $row['medianame'];?>&pid=<?php print $row['parameterid'];?></td><td><?php print $row['created_at'];?></td>
                            <td><form method="post" action="./campaigndetail">
                                    <input type="hidden" name="pid" value="<?php print $row['parameterid'];?>">
                                    <input type="hidden" name="mid" value="<?php print $row['medianame'];?>">
                                    <input type="hidden" name="to" value="________">
                                    <input type="submit" value="check" class="btn">
                                </form></td></tr>
                    </tbody>
