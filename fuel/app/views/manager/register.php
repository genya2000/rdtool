...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="register">キャンペーン登録</a></li>
	...
	<p class="lead">ここでは、リダイレクトURLを発行します。</p>
                ...
                <form name="f1" method="post" action="./register" onSubmit="return checkForm()">
	...
	<input type="submit" value="送信" class="btn">
                ...
                <div style="width:95%;height:150px;margin:0 auto;padding:20px;border: 4px solid #cccccc;margin-top:30px;">リダイレクトURL<br>
                    <strong><?php if(isset($parameterurl)){ echo $parameterurl; }; ?></strong>
                </div>
