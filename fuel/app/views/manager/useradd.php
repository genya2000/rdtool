...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="useradd">メディア登録</a></li>
	...
	<p class="lead">ユーザーID／所属グループ登録</p>
        ...
        <div class="starter-template">
           ...
           <form method="post" action="">
            ...
            <div class="form-group">
                <label for="name">ユーザ名(半角英数字)</label>
                
		
                <input size="18" type="text" maxlength="256" name="username" value="<?php $username; ?>" style="ime-mode:disabled;" class="form-control" required>
		...
		<label for="name">パスワード</label>
                ...
                <input size="20" type="text" maxlength="5000" name="password" value="<?php $password; ?>" style="ime-mode:disabled;" class="form-control" required>
		
                </div>
            
                
            <div class="form-group">       
		<!-- <label for="name">所属グループ(半角英数字)</label> -->
                <input size="20" type="hidden" maxlength="5000" name="group" value="1" style="ime-mode:disabled;" class="form-control" requir
                </div>
		...
		<label for="name">所属グループ(半角英数字)</label>
            -->
                <input size="20" type="hidden" maxlength="5000" name="usergroup" value="media" style="ime-mode:disabled;" class="form-control" required>		
            <!--
            </div>
               -->
               
            <div class="form-group">       
		<label for="name">メディア名(半角英数字)</label>
                
                
                <input size="20" type="text" maxlength="5000" name="medianame" value="<?php $medianame; ?>" style="ime-mode:disabled;" class="form-control" required>
		
                </div>
           
               
            <div class="form-group">       
		<label for="name">メールアドレス(半角英数字)</label>
         
                
                <input size="20" type="text" maxlength="5000" name="email" value="<?php $email; ?>" class="form-control" required>
